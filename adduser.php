...
if (isset($_POST)) {
    ...
    if ($domain !== $allowedDomain) {
        $_SESSION['registerError'] = "Only Gmail accounts are allowed for registration";
        header("Location: register-user.php");
        exit();
    }
    ...
    if ($result->num_rows == 0) {
        ...
        header("Location: register-user.php");
        //echo "<script>alert('Email Already Exists! Choose A Different Email!'); window.location.href = 'register-user.php';</script>";
        exit();
    }
