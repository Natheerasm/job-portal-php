                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card"></a></td>
                                                        <td>
                                                            <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>" class=" btn btn-action btn-danger"><i class="fa fa-trash"></i></a>
                                                        </td>
                                            </tbody>
                                    <?php
                                                    }
