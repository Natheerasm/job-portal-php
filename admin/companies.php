          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="menu-dropdown">
                ...
                <liclass="active"><a href="companies.php"><i class="ion ion-ios-circle-outline"></i> Company</a>
            </li>
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <td>
                              ...
                              ?>
                                <a class="badge badge-danger" href="reject-company.php?id=<?php echo $row['id_company']; ?>">Reject</a> <a class="badge badge-success" href="approve-company.php?id=<?php echo $row['id_company']; ?>">Approve</a>
                              <?php
                              } else if ($row['active'] == '3') {
                              ?>
                                <a class="badge badge-success" href="approve-company.php?id=<?php echo $row['id_company']; ?>">Reactivate</a>
                              <?php
                            ...
                            <td><a href="delete-company.php?id=<?php echo $row['id_company']; ?>" class="btn btn-action btn-danger"> <i class="fa fa-trash"> Delete</i></a></td>
