            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <b>
                                    ...
                                    <div class="container-xxl py-2 wow fadeInUp" data-wow-delay="0.1s">
                                        ...
                                        <div class="container ">
                                            <div class="pull-right">
                                                <a href="my-job-post.php" class="btn btn-info btn-lg btn-flat "><i class="fa fa-arrow-circle-left"></i> Back</a>
                                            </div>

                                            <div class="row gy-5 gx-4 ">
                                                <div class="col-lg-8">
                                                    <?php
                                                    $sql = "SELECT * FROM job_post INNER JOIN company ON job_post.id_company = company.id_company WHERE job_post.id_company='{$_SESSION['id_company']}' AND id_jobpost='$_GET[id]'";
