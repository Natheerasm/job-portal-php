                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="menu-dropdown">
                                <li class="active"><a href="user-details-upadate.php"><i class="ion ion-ios-circle-outline"></i>User
                                        Details</a>
                                </li>
                                    ...
                                    ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <?php if (isset($_SESSION['uploadError']) && !empty($_SESSION['uploadError'])) { ?>
                                                        <div class="row">
                                                            <div class="col-6 m-4 text-center text-danger">
                                                                <?php echo $_SESSION['uploadError']; ?>
                                                            </div>
                                                        </div>
                                                    <?php
                                                        // Clear the uploadError session variable after displaying the error message
